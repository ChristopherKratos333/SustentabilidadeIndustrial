...
const Contact: React.FC = () => {
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="bg-white pb-12 pt-12 text-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
          ...
          <div className="bg-transparent lg:w-1/3 space-y-8 pt-4">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Conecte-se conosco</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Rua Dr. Olavo Egídio, 58 - Rio de Janeiro, RJ</p>
                </div>
              </div>
               ...
               <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 text-sm">Número</h3>
               ...
               <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 text-sm">E-mail</h3>
                  <p className="text-gray-600 text-sm">ecotrace@gmail.com</p>
                </div>
              </div>
            </div>

            <div className="flex gap-4 mt-8">
              <a href="#" className="flex items-center gap-2 text-sm text-gray-700 hover:text-[#1e5336]">
          ...
          {/* Right Side Form */}
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:w-5/12 border border-gray-100 w-full">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Contate-nos</h2>
            <form className="space-y-5">
              <div className="relative">
                <input 
                  type="text" 
                  id="name" 
                  className="peer w-full bg-transparent border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-[#1e5336] py-2" 
                  placeholder="Nome"
                />
                <label 
                  htmlFor="name" 
               ...
               <div className="relative">
                <textarea 
                  id="message" 
                  rows={4}
                  className="peer w-full bg-transparent border border-gray-300 rounded-lg text-gray-900 placeholder-transparent focus:outline-none focus:border-[#1e5336] p-2 mt-4" 
                  placeholder="Mensagem"
                ></textarea>
                <label 
                  htmlFor="message" 
                  className="absolute left-2 top-0 text-gray-600 text-sm transition-all bg-white px-1"
                >
                  Mensagem
                </label>
              </div>
      ...
      {/* Map Placeholder */}
      <div className="w-full h-64 bg-gray-200 mt-12 grayscale opacity-80">
        <img 
