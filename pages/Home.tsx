    ...
    <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24 flex flex-col-reverse md:flex-row items-center gap-12">
        ...
        <div className="md:w-1/2 relative">
          ...
          <div className="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-green-200/50 dark:bg-green-900/30 rounded-full blur-3xl"></div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-950 transition-colors">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Bem-vindo ao EcoTrace</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Feature 1 */}
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all group flex flex-col items-center text-center">
              <div className="mb-6 p-4 bg-green-50 dark:bg-gray-700 rounded-full group-hover:bg-[#1e5336] transition-colors duration-300">
                <TrendingUp className="w-10 h-10 text-[#1e5336] dark:text-[#72b63b] group-hover:text-white" />
              </div>
              <h3 className="font-bold bg-[#72b63b] text-white py-1 px-4 rounded-full text-sm mb-4 w-full">Rastreamento de resíduos</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Gerando, transportando e destinando com eficiência.</p>
            </div>

            {/* Feature 2 */}
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all group flex flex-col items-center text-center">
               <div className="mb-6 p-4 bg-green-50 dark:bg-gray-700 rounded-full group-hover:bg-[#1e5336] transition-colors duration-300">
                <Zap className="w-10 h-10 text-[#1e5336] dark:text-[#72b63b] group-hover:text-white" />
              </div>
              <h3 className="font-bold bg-[#72b63b] text-white py-1 px-4 rounded-full text-sm mb-4 w-full">Monitoramento energético</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Controlando o consumo para reduzir custos e impactos.</p>
            </div>

            {/* Feature 3 */}
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all group flex flex-col items-center text-center">
               <div className="mb-6 p-4 bg-green-50 dark:bg-gray-700 rounded-full group-hover:bg-[#1e5336] transition-colors duration-300">
                <PieChart className="w-10 h-10 text-[#1e5336] dark:text-[#72b63b] group-hover:text-white" />
              </div>
              <h3 className="font-bold bg-[#72b63b] text-white py-1 px-4 rounded-full text-sm mb-4 w-full">Relatórios ESG</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Transformando dados em ações sustentáveis.</p>
            </div>

            {/* Feature 4 */}
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all group flex flex-col items-center text-center">
               <div className="mb-6 p-4 bg-green-50 dark:bg-gray-700 rounded-full group-hover:bg-[#1e5336] transition-colors duration-300">
                <ShieldCheck className="w-10 h-10 text-[#1e5336] dark:text-[#72b63b] group-hover:text-white" />
              </div>
              <h3 className="font-bold bg-[#72b63b] text-white py-1 px-4 rounded-full text-sm mb-4 w-full">Compliance ambiental</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Garantindo conformidade e transparência em cada etapa.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden p-8 lg:p-12 transition-colors">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">
              ...
              <span className="italic font-serif text-gray-500 dark:text-gray-400">assim como nossos clientes</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-black rounded-2xl flex items-center justify-center p-8 aspect-square relative overflow-hidden group">
             ...
             <div className="bg-gray-200 dark:bg-gray-800 rounded-2xl overflow-hidden aspect-square relative group">
            ...
            <div className="bg-black rounded-2xl flex items-center justify-center p-8 aspect-square relative group">
             ...
             <div className="bg-gray-200 dark:bg-gray-800 rounded-2xl overflow-hidden aspect-square relative">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/3 space-y-6">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white leading-tight">
              Somos <span className="italic font-serif text-gray-500 dark:text-gray-400">líderes</span> em <br />
              todas as categorias
            </h2>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="lg:w-2/3 w-full space-y-4">
            {/* Bar 1 */}
            <div className="w-full h-12 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden flex">
              ...
              <div className="h-full flex-grow flex items-center justify-end px-4">
                <span className="text-gray-500 dark:text-gray-400 text-xs font-bold">82%</span>
              </div>
            </div>

            {/* Bar 2 */}
            <div className="w-full h-12 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden flex">
               <div className="h-full bg-gray-400 dark:bg-gray-600 w-[74%] flex items-center px-4">
                <span className="text-white font-bold text-sm">EcoNova</span>
              </div>
              <div className="h-full flex-grow flex items-center justify-end px-4 bg-gray-600 dark:bg-gray-900">
             ...
             {/* Bar 3 */}
            <div className="w-full h-12 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden flex">
               <div className="h-full bg-gray-400 dark:bg-gray-600 w-[67%] flex items-center px-4">
             ...
             {/* Bar 4 */}
            <div className="w-full h-12 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden flex">
               <div className="h-full bg-gray-400 dark:bg-gray-600 w-[49%] flex items-center px-4">
             ...
             {/* Bar 5 */}
            <div className="w-full h-12 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden flex">
               <div className="h-full bg-gray-400 dark:bg-gray-600 w-[41%] flex items-center px-4">
